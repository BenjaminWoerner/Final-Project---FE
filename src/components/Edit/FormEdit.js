   ...
   <div className="top-nav">
    ...
    <div className="signup home-box form">
      <form onSubmit={this.handleFormSubmit}>
        ...
        <input  type="text" name="image" value={image} onChange={ e => this.handleChange(e)} /><br />
        ...
        <textarea type="text" name="methods" value={methods} onChange={ e => this.handleChange(e)}/><br />
